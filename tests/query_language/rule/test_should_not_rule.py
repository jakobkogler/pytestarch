...
def test_should_not_import_anything_positive(
    ...
    rule = Rule().modules_that().are_named(MODULE_5).should_not().import_anything()
...
def test_should_not_import_anything_negative(
    ...
    rule = Rule().modules_that().are_named(MODULE_7).should_not().import_anything()
